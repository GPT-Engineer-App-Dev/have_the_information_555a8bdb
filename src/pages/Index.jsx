...
const Index = () => {
  const [form, setForm] = useState({
    ...
    lineSpeed: "",
    printSize: "",
    uniqueNumber: Math.floor(100000 + Math.random() * 900000) // Generate a unique number
  });
  ...
  const handleSubmit = (e) => {
    ...
    toast({
      ...
      description: `We've received your sample request. Your tracking number is ${form.uniqueNumber}. Please use the following address for shipping: \nCyklop CSC Att.: SampleLab M.Slot ${form.uniqueNumber}\nWilhelm Röntgenstraat 10\n8013NC\nZwolle\nNederland`,
      status: "success",
      duration: 5000,
      isClosable: true,
    });
